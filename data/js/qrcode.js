...
(function () {
	...
	var Drawing = useSVG ? svgDrawer : !_isSupportCanvas() ? (function () {
		...
		Drawing.prototype.draw = function (oQRCode) {
			...
			//edit
            //switched innerHTML for createElement and append
            //(firefox add-on approval warning below)
           ...
           // Warning: Due to both security and performance reasons, innerHTML should not be set using dynamic values. This can lead to security issues or fairly serious performance degradation.
            ...
            for (var i = 0; i < nCount; ++i) {
                ...
                for (var j = 0; j < nCount; ++j) {
                    ...
                    col.style.cssText = "border:0;border-collapse:collapse;padding:0;margin:0;width:" + nWidth + "px;height:" + nHeight + "px;background-color:" + (oQRCode.isDark(row, col) ? _htOption.colorDark : _htOption.colorLight) + ";";
                    row.appendChild(col);
                 }
